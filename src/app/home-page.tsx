...
export default function HomePage({
  ...
  return (
    <div className="flex flex-col min-h-full bg-background/80">
      ...
      <footer className="px-8 py-6 border-t border-cyan-500/20 flex items-center justify-between text-[10px] font-bold text-cyan-500/40 uppercase tracking-widest font-mono">
        <p>© 2024 AI NAV — CYBER.DECK</p>
